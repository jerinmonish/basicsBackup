...
import { BloodgroupDropDownList, ReligionDropDownList, CommonCountryList, CommonStateList, CommonDistrictList } from './../../../actions/commonAction';
import { EmployeeUpdateAPI, AadharIdApi, PanIdApi } from 'src/actions/master';
...
const Tab2 = (props) => {
  ...
  const { aadharData, panData, isLoading } = useSelector((state) => state.masterBackend);
  // const smm = useSelector((state) => state.masterBackend);
  // console.log(smm);
  //Dropdown Data
  ...
  useEffect(() => {
    if (props?.dataEdit?.data !== null) {
      Tab2Formik.setValues({
        "birthday": indianDateFormat(props?.dataEdit?.data?.birthday),
        ...
        "aadhar": props?.dataEdit?.data?.aadhar,
        //"pan_proof":props?.dataEdit?.data?.pan_proof,
        "pan_id": props?.dataEdit?.data?.pan_id,
      ...
      if (props?.dataEdit?.data?.is_disabled === true) {
        Tab2Formik.setFieldValue('is_disabled', 1);
        setHideDisabilitiesArea(1);
        setIsPhyDisab(true);
      } else {
        Tab2Formik.setFieldValue('is_disabled', 0);
        setHideDisabilitiesArea(0);
        setIsPhyDisab(false);
      }

      if (props?.dataEdit?.data?.is_international_worker === true) {
        Tab2Formik.setFieldValue('is_international_worker', 1);
        setIsInternationalWorker(true);
      } else {
        Tab2Formik.setFieldValue('is_international_worker', 0);
  ...
  const Tab2Formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      ...
      mobile_phone: Yup.number().typeError("That doesn't look like a mobile number").required('This field is required'),
      ...
      aadhar: Yup.number().typeError("That doesn't look like a mobile number").required('This field is required'),
      name_as_per_aadhar: Yup.string().required('This field is required'),
      // pan_proof:Yup.string().required('This field is required'),
      pan_id: Yup.string().required('This field is required').matches(/^([a-zA-Z]){5}([0-9]){4}([a-zA-Z]){1}?$/, "Must be a valid PAN Number"),
      name_as_per_pan: Yup.string().required('This field is required'),
      // voter_proof:'',
      voter_id: Yup.string().required('This field is required').matches(/^[A-Z]{3}[0-9]{7}$/, "Must be a valid Voter ID"),
      ...
      uan_no: Yup.number().required('This field is required'),
  ...
  const handledateOfBir = (date) => {
    if (date) {
      setdateOfBir(date)
      Tab2Formik.setFieldValue('birthday', indianDateFormat(date._d));
    }
  }
  ...
  const handledateOfPExp = (date) => {
    if (date) {
      setdateOfPExp(date)
      Tab2Formik.setFieldValue('passport_expiry_date', indianDateFormat(date._d));
    }
  }
  ...
  const handledateOfJoining = (date) => {
    if (date) {
      ...
      Tab2Formik.setFieldValue('epf_joining_date', indianDateFormat(date._d));
    }
  }
  ...
  const handledateOfLeaving = (date) => {
    if (date) {
      ...
      Tab2Formik.setFieldValue('epf_leaving_date', indianDateFormat(date._d));
    }
  }

  const handleGender = (e) => {
    if (e) {
      Tab2Formik.setFieldValue('gender', e.value);
  ...
  const handleBloodGroup = (e) => {
    if (e) {
      Tab2Formik.setFieldValue('blood_group_id', e.value);
  ...
  const handleReligion = (e) => {
    if (e) {
      Tab2Formik.setFieldValue('religion_id', e.value);
  ...
  const handleMaritalStatusChange = (e) => {
    if (e?.value) {
      Tab2Formik.setFieldValue('marital', e.value);
  ...
  const handledateOfMarriage = (date) => {
    if (date) {
      ...
      Tab2Formik.setFieldValue('marriage_date', indianDateFormat(date._d));
    }
  }
  ...
  const handlespouseDob = (date) => {
    if (date) {
      setspouseDob(date)
      Tab2Formik.setFieldValue('spouse_birthdate', indianDateFormat(date._d));
    }
  }
  ...
  const handleCurrentCountry = (e) => {
    if (e?.value) {
      ...
      Tab2Formik.setFieldValue('cur_country_id', e.value);
  ...
  const handleCurrentState = (e) => {
    if (e?.value) {
      ...
      Tab2Formik.setFieldValue('cur_state_id', e.value);
  ...
  const handleCurrentDistrict = (e) => {
    if (e?.value) {
      ...
      Tab2Formik.setFieldValue('cur_district_id', e.value);
    }
  }
  ...
  const handlePermanentCountry = (e) => {
    if (e?.value) {
      ...
      Tab2Formik.setFieldValue('country_id', e.value);
      dispatch(CommonStateList(e.value));
      onPerCountryClear();
      onPerStateClear();
    }
  ...
  const handlePermanentState = (e) => {
    if (e?.value) {
      ...
      Tab2Formik.setFieldValue('state_id', e.value);
      dispatch(CommonDistrictList(e.value));
      onPerStateClear();
    }
  }
  ...
  const handlePermanentDistrict = (e) => {
    if (e?.value) {
      ...
      Tab2Formik.setFieldValue('district_id', e.value);
    }
  }
  ...
  const handleVoterCountry = (e) => {
    if (e?.value) {
      ...
      Tab2Formik.setFieldValue('voter_country_id', e.value);
    }
  }
  ...
  const handlePassportCountry = (e) => {
    if (e?.value) {
      ...
      Tab2Formik.setFieldValue('passport_country_id', e.value);
    }
  }

  const markasCurrentAddress = (e) => {
    //console.log(Tab2Formik?.values,curCountry);
    if (e.target.checked === true) {
      Tab2Formik.setFieldValue("door_no", Tab2Formik?.values?.cur_door_no)
      Tab2Formik.setFieldValue("house_name", Tab2Formik?.values?.cur_house_name)
      Tab2Formik.setFieldValue("street_name", Tab2Formik?.values?.cur_street_name)
      Tab2Formik.setFieldValue("place_name", Tab2Formik?.values?.cur_place_name)
      Tab2Formik.setFieldValue("pin_code", Tab2Formik?.values?.cur_pin_code)
      Tab2Formik.setFieldValue("country_id", Tab2Formik?.values?.cur_country_id)
      setPerCountry(convertValueLabel(curCountry?.value, curCountry.label));
      Tab2Formik.setFieldValue("state_id", Tab2Formik?.values?.cur_state_id)
      setPerStateName(convertValueLabel(curStateName?.value, curStateName.label));
      Tab2Formik.setFieldValue("district_id", Tab2Formik?.values?.cur_district_id)
      setPerDistrictName(convertValueLabel(curDistrictName?.value, curDistrictName.label));
    } else {
      Tab2Formik.setFieldValue("door_no", "")
      Tab2Formik.setFieldValue("house_name", "")
      Tab2Formik.setFieldValue("street_name", "")
      Tab2Formik.setFieldValue("place_name", "")
      Tab2Formik.setFieldValue("pin_code", "")
      Tab2Formik.setFieldValue("country_id", "")
      setPerCountry(convertValueLabel());
      Tab2Formik.setFieldValue("state_id", "")
      setPerStateName(convertValueLabel());
      Tab2Formik.setFieldValue("district_id", "")
      setPerDistrictName(convertValueLabel());
    }
  }
    ...
    if (files.length > 0) {
      ...
      fileReader.onload = (event) => {
        setAadharImgSelected({
          selectedImage: Tab2Formik.setFieldValue("aadhar_proof", event.target.result),
        })
  ...
  const handleAadharNoChange = (ev) => {
    ...
    Tab2Formik.setFieldValue("aadhar", ev);
  }

  const handleAadharNameChange = (ev) => {
    setAadharImgName(ev);
    Tab2Formik.setFieldValue("name_as_per_aadhar", ev);
  }

  const handlePanCardNoChange = (ev) => {
    setPanImgNumber(ev);
    Tab2Formik.setFieldValue("pan_id", ev);
  }

  const handlePanCardNameChange = (ev) => {
    setPanImgName(ev);
    Tab2Formik.setFieldValue("name_as_per_pan", ev);
  }
  ...
  const handlePanIdChange = (i) => {
    ...
    fileReader.onload = (event) => {
      setPanImgSelected({
        selectedImage: Tab2Formik.setFieldValue("pan_proof", event.target.result),
      })
      if (event.target.result) {
  ...
  const handleVoterIdChange = (i) => {
    ...
    fileReader.onload = (event) => {
      setVoterImgSelected({
        selectedImage: Tab2Formik.setFieldValue("voter_proof", event.target.result),
      })
    }
  }
  ...
  const handlePassportIdChange = (i) => {
    ...
    fileReader.onload = (event) => {
      setPassportImgSelected({
        selectedImage: Tab2Formik.setFieldValue("passport_proof", event.target.result),
      })
    }
  }
    ...
    <CCard className="mb-4">
      {
        (isLoading === true) ? <CLoader /> :
          <CCardBody>
            <CForm onSubmit={Tab2Formik.handleSubmit} className="form-horizontal">
              {/* <div> */}
              <CCard className="mb-4">
                  ...
                  <div className="row">
                    <div className="col-lg-3">
                      <div className="form-group">
                        ...
                        />
                        {/* <TextMask mask={[/\d/, /\d/, '/', /\d/, /\d/, '/', /\d/, /\d/, /\d/, /\d/]} Component={InputAdapter} className="form-control" name='birthday' placeholder='Date Of Birth' onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.birthday}/> */}
                        {Tab2Formik.errors.birthday && Tab2Formik.touched.birthday ? <div className="help-block text-danger">{Tab2Formik.errors.birthday}</div> : null}
                      </div>
                    </div>
                    <div className="col-lg-3">
                      <div className="form-group">
                        ...
                        <div className="">
                          <Select
                            ...
                            onBlur={Tab2Formik.handleBlur}
                          />
                          {Tab2Formik.errors.gender && Tab2Formik.touched.gender ? <div className="help-block text-danger">{Tab2Formik.errors.gender}</div> : null}
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-3">
                      <div className="form-group">
                        <label htmlFor="">Blood Group <span className='error'>*</span></label>
                        <div className="">
                          ...
                          <Select
                            ...
                            onBlur={Tab2Formik.handleBlur}
                          />
                          {Tab2Formik.errors.blood_group_id && Tab2Formik.touched.blood_group_id ? <div className="help-block text-danger">{Tab2Formik.errors.blood_group_id}</div> : null}
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-3">
                      <div className="form-group">
                        <label htmlFor="">Religion <span className='error'>*</span></label>
                        <div className="">
                          {/* <input type="text" className="form-control col-10" /> <Link to=""><label className="ml-1">Generate</label></Link> */}
                          <Select
                            className="basic-single"
                            ...
                            onBlur={Tab2Formik.handleBlur}
                          />
                          {Tab2Formik.errors.religion_id && Tab2Formik.touched.religion_id ? <div className="help-block text-danger">{Tab2Formik.errors.religion_id}</div> : null}
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-lg-3">
                      <div className="form-group">
                        ...
                        <input type="text" name='personal_email' className="form-control" placeholder='Personal Email' maxLength={50} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.personal_email} />
                        {Tab2Formik.errors.personal_email && Tab2Formik.touched.personal_email ? <div className="help-block text-danger">{Tab2Formik.errors.personal_email}</div> : null}
                      </div>
                    </div>
                    <div className="col-lg-3">
                      <div className="form-group">
                        <label htmlFor="">Personal Mobile Number <span className='error'>*</span></label>
                        <input type="text" name='mobile_phone' className="form-control" placeholder='Personal Mobile Number' maxLength={10} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.mobile_phone} />
                        {Tab2Formik.errors.mobile_phone && Tab2Formik.touched.mobile_phone ? <div className="help-block text-danger">{Tab2Formik.errors.mobile_phone}</div> : null}
                      </div>
                    </div>
                    <div className="col-lg-3">
                      <div className="form-group">
                        <label htmlFor="">Emergency Contact <span className='error'>*</span></label>
                        <input type="text" name='emergency_contact' className="form-control" placeholder='Emergency Contact' maxLength={10} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.emergency_contact} />
                        {Tab2Formik.errors.emergency_contact && Tab2Formik.touched.emergency_contact ? <div className="help-block text-danger">{Tab2Formik.errors.emergency_contact}</div> : null}
                      </div>
                    </div>
                    <div className="col-lg-3">
                      <div className="form-group">
                        <label htmlFor="">Emergency Contact Person <span className='error'>*</span></label>
                        <input type="text" name='emergency_contact_person' className="form-control" placeholder='Emergency Contact Person' maxLength={20} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.emergency_contact_person} />
                        {Tab2Formik.errors.emergency_contact_person && Tab2Formik.touched.emergency_contact_person ? <div className="help-block text-danger">{Tab2Formik.errors.emergency_contact_person}</div> : null}
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-lg-3">
                      <div className="form-group">
                        ...
                        <Select
                          ...
                          onBlur={Tab2Formik.handleBlur}
                        />
                        {Tab2Formik.errors.marital && Tab2Formik.touched.marital ? <div className="help-block text-danger">{Tab2Formik.errors.marital}</div> : null}
                      </div>
                    </div>
                          ...
                          <>
                            <div className="col-lg-3">
                              <div className="form-group">
                                ...
                                <input type="text" name='spouse_complete_name' className="form-control" placeholder='Spouse Complete Name' maxLength={20} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.spouse_complete_name} />
                                {Tab2Formik.errors.spouse_complete_name && Tab2Formik.touched.personal_email ? <div className="help-block text-danger">{Tab2Formik.errors.spouse_complete_name}</div> : null}
                              </div>
                            </div>
                            <div className="col-lg-3">
                              <div className="form-group">
                                ...
                                />
                                {Tab2Formik.errors.marriage_date && Tab2Formik.touched.marriage_date ? <div className="help-block text-danger">{Tab2Formik.errors.marriage_date}</div> : null}
                              </div>
                            </div>
                            <div className="col-lg-3">
                              <div className="form-group">
                                <label htmlFor="">Spouse Birth of Date <span className='error'>*</span></label>
                                <SingleDatePicker
                                  id={'spouse_birthdate'}
                                  date={spouseDob}
                                  ...
                                  displayFormat="DD-MM-YYYY"
                                  isOutsideRange={() => false}
                                  placeholder='Spouse Birth of Date'
                                  readOnly={true}
                                  renderMonthElement={({ month, onMonthSelect, onYearSelect }) =>
                                    <div style={{ display: 'flex', justifyContent: 'center' }}>
                                      <div>
                                ...
                                />
                                {Tab2Formik.errors.spouse_birthdate && Tab2Formik.touched.spouse_birthdate ? <div className="help-block text-danger">{Tab2Formik.errors.spouse_birthdate}</div> : null}
                              </div>
                            </div>
                          </>
                        )
                  ...
                  <div className="row">
                    <div className="col-lg-3">
                      <div className="form-group">
                        ...
                        {Tab2Formik.errors.is_disabled && Tab2Formik.touched.is_disabled ? <div className="help-block text-danger">{Tab2Formik.errors.is_disabled}</div> : null}
                      </div>
                    </div>
                    {(() => {
                      if (hideDisabilitiesArea) {
                        return (
                          <>
                            <div className="col-lg-3">
                              <div className="form-group">
                                <label htmlFor="">Disabilities <span className='error'>*</span></label>
                                <textarea type="text" name='disabilities' className="form-control" placeholder='Disabilities' maxLength={500} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.disabilities}></textarea>
                                {Tab2Formik.errors.disabilities && Tab2Formik.touched.personal_email ? <div className="help-block text-danger">{Tab2Formik.errors.disabilities}</div> : null}
                              </div>
                            </div>
                          </>
                        )
                ...
                <CCardBody>
                  <div className="row form-group">
                    <div className="col-md-3">
                      ...
                      <input type="text" name='cur_door_no' value={Tab2Formik.values.cur_door_no} className="form-control" placeholder='Door No' maxLength={25} onChange={Tab2Formik.handleChange} />
                      {Tab2Formik.errors.door_no && Tab2Formik.touched.door_no ? <div className="help-block text-danger">{Tab2Formik.errors.cur_door_no}</div> : null}
                    </div>
                    <div className="col-md-3">
                      <label htmlFor="hf-email">House/Apartment Name <span className='error'>*</span></label>
                      <input type="text" name='cur_house_name' value={Tab2Formik.values.cur_house_name} className="form-control" placeholder='House/Apartment Name' maxLength={25} onChange={Tab2Formik.handleChange} />
                      {Tab2Formik.errors.cur_house_name && Tab2Formik.touched.cur_house_name ? <div className="help-block text-danger">{Tab2Formik.errors.cur_house_name}</div> : null}
                    </div>
                    <div className="col-md-3">
                      <label htmlFor="hf-email">Street Name <span className='error'>*</span></label>
                      <input type="text" name='cur_street_name' value={Tab2Formik.values.cur_street_name} className="form-control" placeholder='Street Name' maxLength={25} onChange={Tab2Formik.handleChange} />
                      {Tab2Formik.errors.cur_street_name && Tab2Formik.touched.cur_street_name ? <div className="help-block text-danger">{Tab2Formik.errors.cur_street_name}</div> : null}
                    </div>
                    <div className="col-md-3">
                      <label htmlFor="hf-email">Place Name <span className='error'>*</span></label>
                      <input type="text" name='cur_place_name' value={Tab2Formik.values.cur_place_name} className="form-control" placeholder='Place Name' maxLength={25} onChange={Tab2Formik.handleChange} />
                      {Tab2Formik.errors.cur_place_name && Tab2Formik.touched.cur_place_name ? <div className="help-block text-danger">{Tab2Formik.errors.cur_place_name}</div> : null}
                    </div>
                  </div>
                  ...
                  <div className="row form-group">
                    <div className="col-md-3">
                      ...
                      <Select
                        ...
                        onBlur={Tab2Formik.handleBlur}
                      />
                      {Tab2Formik.errors.country_id && Tab2Formik.touched.country_id ? <div className="help-block text-danger">{Tab2Formik.errors.country_id}</div> : null}
                    </div>
                    <div className="col-md-3">
                      ...
                      <Select
                        ...
                        onBlur={Tab2Formik.handleBlur}
                      />
                      {Tab2Formik.errors.state_id && Tab2Formik.touched.state_id ? <div className="help-block text-danger">{Tab2Formik.errors.state_id}</div> : null}
                    </div>
                    <div className="col-md-3">
                      ...
                      <Select
                        ...
                        onBlur={Tab2Formik.handleBlur}
                      />
                      {Tab2Formik.errors.district_id && Tab2Formik.touched.district_id ? <div className="help-block text-danger">{Tab2Formik.errors.district_id}</div> : null}
                    </div>
                    <div className="col-md-3">
                      <label htmlFor="hf-email">Zip <span className='error'>*</span></label>
                      <input type="text" name='cur_pin_code' value={Tab2Formik.values.cur_pin_code} onChange={Tab2Formik.handleChange} className="form-control" placeholder='Zip' maxLength={10} />
                      {Tab2Formik.errors.cur_pin_code && Tab2Formik.touched.cur_pin_code ? <div className="help-block text-danger">{Tab2Formik.errors.cur_pin_code}</div> : null}
                    </div>
                  </div>
                </CCardBody>
              </CCard>
              <CCard className="mb-4">
                ...
                <CCardBody>
                  <div className="row form-group">
                    <div className="col-md-3">
                      <label htmlFor="hf-email">Door No <span className='error'>*</span></label>
                      <input type="text" name='door_no' value={Tab2Formik.values.door_no} className="form-control" placeholder='Door No' maxLength={25} onChange={Tab2Formik.handleChange} />
                      {Tab2Formik.errors.door_no && Tab2Formik.touched.door_no ? <div className="help-block text-danger">{Tab2Formik.errors.door_no}</div> : null}
                    </div>
                    <div className="col-md-3">
                      <label htmlFor="hf-email">House/Apartment Name <span className='error'>*</span></label>
                      <input type="text" name='house_name' value={Tab2Formik.values.house_name} className="form-control" placeholder='House/Apartment Name' maxLength={25} onChange={Tab2Formik.handleChange} />
                      {Tab2Formik.errors.house_name && Tab2Formik.touched.house_name ? <div className="help-block text-danger">{Tab2Formik.errors.house_name}</div> : null}
                    </div>
                    <div className="col-md-3">
                      <label htmlFor="hf-email">Street Name <span className='error'>*</span></label>
                      <input type="text" name='street_name' value={Tab2Formik.values.street_name} className="form-control" placeholder='Street Name' maxLength={25} onChange={Tab2Formik.handleChange} />
                      {Tab2Formik.errors.street_name && Tab2Formik.touched.street_name ? <div className="help-block text-danger">{Tab2Formik.errors.street_name}</div> : null}
                    </div>
                    <div className="col-md-3">
                      <label htmlFor="hf-email">Place Name <span className='error'>*</span></label>
                      <input type="text" name='place_name' value={Tab2Formik.values.place_name} className="form-control" placeholder='Place Name' maxLength={25} onChange={Tab2Formik.handleChange} />
                      {Tab2Formik.errors.place_name && Tab2Formik.touched.place_name ? <div className="help-block text-danger">{Tab2Formik.errors.place_name}</div> : null}
                    </div>
                  </div>
                  ...
                  <div className="row form-group">
                    ...
                    <div className="col-md-3">
                      <label htmlFor="hf-email">Zip <span className='error'>*</span></label>
                      <input type="text" name='pin_code' value={Tab2Formik.values.pin_code} onChange={Tab2Formik.handleChange} className="form-control" placeholder='Zip' maxLength={10} />
                      {Tab2Formik.errors.pin_code && Tab2Formik.touched.pin_code ? <div className="help-block text-danger">{Tab2Formik.errors.zpin_codeip}</div> : null}
                    </div>
                  </div>
                </CCardBody>
              </CCard>
              ...
              <CCard className="mb-4">
                ...
                <CCardBody>
                  <div className="row form-group">
                    ...
                    <div className="col-lg-4">
                      <label htmlFor="">Aadhar Number test <span className='error'>*</span></label>
                      <input type="text" name='aadhar' id='aadhar' className="form-control" placeholder='eg : 374555254523' maxLength={12} onChange={e => handleAadharNoChange(e.target.value)} onBlur={Tab2Formik.handleBlur} value={aadharImgNumber} />
                      {Tab2Formik.errors.aadhar && Tab2Formik.touched.aadhar ? <div className="help-block text-danger">{Tab2Formik.errors.aadhar}</div> : null}
                    </div>
                    <div className="col-lg-4">
                      <label htmlFor="">Name as per Aadhar <span className='error'>*</span></label>
                      <input type="text" name='name_as_per_aadhar' className="form-control" placeholder='Name as per Aadhar' maxLength={50} onChange={e => handleAadharNameChange(e.target.value)} onBlur={Tab2Formik.handleBlur} value={aadharImgName} />
                      {Tab2Formik.errors.name_as_per_aadhar && Tab2Formik.touched.name_as_per_aadhar ? <div className="help-block text-danger">{Tab2Formik.errors.name_as_per_aadhar}</div> : null}
                    </div>
                  </div>
                </CCardBody>
              </CCard>
                ...
                <CCardBody>
                  <div className="row form-group">
                    ...
                    <div className="col-lg-4">
                      ...
                      <input type="text" name='pan_id' className="form-control" placeholder='eg : APGFE7472A' maxLength={10} onChange={e => handlePanCardNoChange(e.target.value)} onBlur={Tab2Formik.handleBlur} value={panImgNumber} />
                      {Tab2Formik.errors.pan_id && Tab2Formik.touched.pan_id ? <div className="help-block text-danger">{Tab2Formik.errors.pan_id}</div> : null}
                    </div>
                    <div className="col-lg-4">
                      <label htmlFor="">Name as per PAN card <span className='error'>*</span></label>
                      <input type="text" name='name_as_per_pan' className="form-control" placeholder='Name as per PAN card' maxLength={50} onChange={e => handlePanCardNameChange(e.target.value)} onBlur={Tab2Formik.handleBlur} value={panImgName} />
                      {Tab2Formik.errors.name_as_per_pan && Tab2Formik.touched.name_as_per_pan ? <div className="help-block text-danger">{Tab2Formik.errors.name_as_per_pan}</div> : null}
                    </div>
                  </div>
                </CCardBody>
              </CCard>
              ...
              <CCard className="mb-4">
                ...
                <CCardBody>
                  <div className="row">
                    ...
                    <div className="col-lg-3">
                      <label htmlFor="">Voter ID Number <span className='error'>*</span></label>
                      <input type="text" name='voter_id' className="form-control" placeholder=' eg : YYY2345363' maxLength={12} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.voter_id} />
                      {Tab2Formik.errors.voter_id && Tab2Formik.touched.voter_id ? <div className="help-block text-danger">{Tab2Formik.errors.voter_id}</div> : null}
                    </div>
                    <div className="col-lg-3">
                      <label htmlFor="">Name as per Voter ID <span className='error'>*</span></label>
                      <input type="text" className='form-control' name='name_as_per_voter_id' placeholder='Name as per Voter ID' maxLength={50} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.name_as_per_voter_id} />
                      {Tab2Formik.touched.name_as_per_voter_id && Tab2Formik.errors.name_as_per_voter_id ? <div className="help-block text-danger">{Tab2Formik.errors.name_as_per_voter_id}</div> : null}
                      {/* <pre>{JSON.stringify(Tab2Formik, null, 2)}</pre> */}
                    </div>
                    <div className="col-md-3">
                      <label htmlFor="hf-email">Voter Country <span className='error'>*</span></label>
                      <Select
                        className="basic-single"
                        classNamePrefix="select"
                        ...
                        onBlur={Tab2Formik.handleBlur}
                      />
                      {Tab2Formik.errors.voter_country_id && Tab2Formik.touched.voter_country_id ? <div className="help-block text-danger">{Tab2Formik.errors.voter_country_id}</div> : null}
                    </div>
                  </div>
                </CCardBody>
              </CCard>
                  ...
                  <div className="row form-group">
                    ...
                    <div className="col-md-3">
                      ...
                      <Select
                        ...
                        onBlur={Tab2Formik.handleBlur}
                      />
                      {Tab2Formik.errors.passport && Tab2Formik.touched.passport ? <div className="help-block text-danger">{Tab2Formik.errors.passport}</div> : null}
                    </div>
                    <div className="col-lg-3">
                      <label htmlFor="">Passport Number <span className='error'>*</span></label>
                      <input type="text" name='passport_id' className="form-control" placeholder='eg : 12345678' maxLength={10} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.passport_id} />
                      {Tab2Formik.errors.passport_id && Tab2Formik.touched.passport_id ? <div className="help-block text-danger">{Tab2Formik.errors.passport_id}</div> : null}
                    </div>
                    <div className="col-lg-3">
                      <label htmlFor="">Surname <span className='error'>*</span></label>
                      <input type="text" name='passport_sur_name' className="form-control" placeholder='Surname' maxLength={20} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.passport_sur_name} />
                      {Tab2Formik.errors.passport_sur_name && Tab2Formik.touched.passport_sur_name ? <div className="help-block text-danger">{Tab2Formik.errors.passport_sur_name}</div> : null}
                    </div>
                  </div>
                  <div className="row form-group">
                    <div className="col-lg-3">
                      <label htmlFor="">Given Name <span className='error'>*</span></label>
                      <input type="text" name='passport_given_name' className="form-control" placeholder='Given Name' maxLength={20} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.passport_given_name} />
                      {Tab2Formik.errors.passport_given_name && Tab2Formik.touched.passport_given_name ? <div className="help-block text-danger">{Tab2Formik.errors.passport_given_name}</div> : null}
                    </div>
                    <div className="col-lg-3">
                      <label htmlFor="">Place Of Issue <span className='error'>*</span></label>
                      <input type="text" name='passport_place_of_issue' className="form-control" placeholder='Place Of Issue' maxLength={20} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.passport_place_of_issue} />
                      {Tab2Formik.errors.passport_place_of_issue && Tab2Formik.touched.passport_place_of_issue ? <div className="help-block text-danger">{Tab2Formik.errors.passport_place_of_issue}</div> : null}
                    </div>
                    <div className="col-lg-3">
                      <label htmlFor="">Date of Expiry <span className='error'>*</span></label>
                      <SingleDatePicker
                      ...
                      />
                      {Tab2Formik.errors.passport_expiry_date && Tab2Formik.touched.passport_expiry_date ? <div className="help-block text-danger">{Tab2Formik.errors.passport_expiry_date}</div> : null}
                    </div>
                    <div className="col-lg-3">
                      <div className="form-group">
                        <CFormGroup variant="custom-checkbox" inline style={{ marginTop: '58px !important' }} id='compay_add_show_caste'>
                        ...
                        {Tab2Formik.errors.is_international_worker && Tab2Formik.touched.is_international_worker ? <div className="help-block text-danger">{Tab2Formik.errors.is_international_worker}</div> : null}
                      </div>
                    </div>
                  </div>
                </CCardBody>
              ...
              <CCard className="mb-4">
                ...
                <CCardBody>
                  <div className="row form-group">
                    <div className="col-lg-3">
                      <label htmlFor="">UAN Number <span className='error'>*</span></label>
                      <input type="text" name='uan_no' className="form-control" placeholder='eg : 461271235725' maxLength={20} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.uan_no} />
                      {Tab2Formik.errors.uan_no && Tab2Formik.touched.uan_no ? <div className="help-block text-danger">{Tab2Formik.errors.uan_no}</div> : null}
                    </div>
                    <div className="col-lg-3" style={{ whiteSpace: 'nowrap' }}>
                      ...
                      <input type="text" name='epf_previous_employer' className="form-control" placeholder='Name of the Previous Employer' maxLength={20} onChange={Tab2Formik.handleChange} onBlur={Tab2Formik.handleBlur} value={Tab2Formik.values.epf_previous_employer} />
                      {Tab2Formik.errors.epf_previous_employer && Tab2Formik.touched.epf_previous_employer ? <div className="help-block text-danger">{Tab2Formik.errors.epf_previous_employer}</div> : null}
                    </div>
                    <div className="col-lg-3">
                      ...
                      />
                      {Tab2Formik.errors.epf_joining_date && Tab2Formik.touched.epf_joining_date ? <div className="help-block text-danger">{Tab2Formik.errors.epf_joining_date}</div> : null}
                    </div>
                    <div className="col-lg-3">
                      ...
                      />
                      {Tab2Formik.errors.epf_leaving_date && Tab2Formik.touched.epf_leaving_date ? <div className="help-block text-danger">{Tab2Formik.errors.epf_leaving_date}</div> : null}
                    </div>
                  </div>
                </CCardBody>
              </CCard>
