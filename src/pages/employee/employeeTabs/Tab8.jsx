...
const Tab8 = (props) => {
  ...
  useEffect(() => {
    if (WorkExperienceData?.empweId?.data && WorkExperienceData?.success === 'working experience add success') {
      props?.dataEdit?.data?.work_experience_ids.push({
        "name": Tab8Formik?.values.name,
        "joining_date": Tab8Formik?.values.joining_date,
        "leaving_date": Tab8Formik?.values.leaving_date,
        "role_played": Tab8Formik?.values.role_played,
        "id": WorkExperienceData?.empweId?.data
      });
      Tab8Formik.resetForm();
    }
  ...
  const handleJoiningDate = (date) => {
    if (date) {
      setjoiningDate(date)
      Tab8Formik.setFieldValue('joining_date', indianDateFormat(date._d));
      Tab8Formik.setFieldValue('employee_id', props.dataId);
    }
  }
  ...
  const handleLeavingDate = (date) => {
    if (date) {
      setleavingDate(date)
      Tab8Formik.setFieldValue('leaving_date', indianDateFormat(date._d));
    }
  }
  ...
  const handleupdateJoiningDate = (date) => {
    if (date) {
      ...
      Tab8UpdateFormik.setFieldValue('joining_date', indianDateFormat(date._d));
      Tab8UpdateFormik.setFieldValue('employee_id', props.dataId);
    }
  }
  ...
  const handleupdateLeavingDate = (date) => {
    if (date) {
      ...
      Tab8UpdateFormik.setFieldValue('leaving_date', indianDateFormat(date._d));
    }
  }


  //WorkingExperience Edit Form Initilization
  const Tab8UpdateFormik = useFormik({
                    ...
                    <CModalBody>
                      {
                        (WorkExperienceData?.isEmpWoeLoading === true) ? 'Saving Please Wait...' :
                          <CForm onSubmit={Tab8Formik.handleSubmit} className="form-horizontal">
                            <CCardBody>
                              <div className="row">
                                <div className="col-lg-4">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      <input type="text" name={`name`} className="form-control" placeholder='Name of the Previous Employer' maxLength={20} onChange={Tab8Formik.handleChange} onBlur={Tab8Formik.handleBlur} value={Tab8Formik.values.name} />
                                      {Tab8Formik.errors.name ? <div className="help-block text-danger">{Tab8Formik.errors.name}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-4">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      <input type="text" name='role_played' className="form-control" placeholder='Role Played' maxLength={20} onChange={Tab8Formik.handleChange} onBlur={Tab8Formik.handleBlur} value={Tab8Formik.values.role_played} />
                                      {Tab8Formik.errors.role_played ? <div className="help-block text-danger">{Tab8Formik.errors.role_played}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-4">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      ...
                                      />
                                      {Tab8Formik.errors.joining_date ? <div className="help-block text-danger">{Tab8Formik.errors.joining_date}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-4">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      ...
                                      />
                                      {Tab8Formik.errors.leaving_date ? <div className="help-block text-danger">{Tab8Formik.errors.leaving_date}</div> : null}
                                    </div>
                                  </div>
                                </div>
                              </div>
                    ...
                    <CModalBody>
                      {
                        (WorkExperienceData?.isEmpWoeLoading === true) ? ' Please Wait...' :
                          <CForm onSubmit={Tab8UpdateFormik.handleSubmit} className="form-horizontal">
                            <CCardBody>
                              <div className="row">
                                <div className="col-lg-4">
                                  <div className="form-group">
                                    <label htmlFor="">Name of the Previous Employer <span className='error'>*</span></label>
                                    <div className="">
                                      <input type="text" name={`name`} className="form-control" placeholder='Name of the Previous Employer' maxLength={20} onChange={Tab8UpdateFormik.handleChange} onBlur={Tab8UpdateFormik.handleBlur} value={Tab8UpdateFormik.values.name} />
                                      {Tab8UpdateFormik.touched.name && Tab8UpdateFormik.errors.name ? <div className="help-block text-danger">{Tab8UpdateFormik.errors.name}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-4">
                                  <div className="form-group">
                                    <label htmlFor="">Role Played <span className='error'>*</span></label>
                                    <div className="">
                                      <input type="text" name='role_played' className="form-control" placeholder='Role Played' maxLength={20} onChange={Tab8UpdateFormik.handleChange} onBlur={Tab8UpdateFormik.handleBlur} value={Tab8UpdateFormik.values.role_played} />
                                      {Tab8UpdateFormik.touched.role_played && Tab8UpdateFormik.errors.role_played ? <div className="help-block text-danger">{Tab8UpdateFormik.errors.role_played}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-4">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      ...
                                      />
                                      {Tab8UpdateFormik.touched.joining_date && Tab8UpdateFormik.errors.joining_date ? <div className="help-block text-danger">{Tab8UpdateFormik.errors.joining_date}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-4">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      ...
                                      />
                                      {Tab8UpdateFormik.touched.leaving_date && Tab8UpdateFormik.errors.leaving_date ? <div className="help-block text-danger">{Tab8UpdateFormik.errors.leaving_date}</div> : null}
                                    </div>
                                  </div>
                                </div>
                              </div>
