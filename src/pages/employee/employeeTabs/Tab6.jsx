...
const Tab6 = (props) => {
  ...
  const Tab6UpdateFormik = useFormik({
    initialValues: {
      name: '',
      relationship_id: '',
      gender: '',
  ...
  const handleDateOfBirth = (date) => {
    if (date) {
      setdateOfBirth(date)
      Tab6Formik.setFieldValue('birthday', indianDateFormat(date._d));
  ...
  const handleDateOfBirthUpdate = (date) => {
    if (date) {
      ...
      Tab6UpdateFormik.setFieldValue('birthday', indianDateFormat(date._d));
      setDobTable(indianDateFormat(date._d));
    }
  }
  ...
  const handleRelationship = (e) => {
    if (e?.value) {
      Tab6Formik.setFieldValue('relationship_id', e.value);
      Tab6Formik.setFieldValue('employee_id', props.dataId);
  ...
  const handleRelationshipupdate = (e) => {
    if (e?.value) {
      Tab6UpdateFormik.setFieldValue('relationship_id', e.value);
      setRelationShipOptions(convertValueLabel(e?.value, e?.label))
      Tab6UpdateFormik.setFieldValue('employee_id', props.dataId);
      setRelationShipTable(e.label);
    }
  }
  ...
  const handleGender = (e) => {
    if (e?.value) {
      Tab6Formik.setFieldValue('gender', e.value);
  ...
  const handleGenderupdate = (e) => {
    if (e?.value) {
      Tab6UpdateFormik.setFieldValue('gender', e.value);
  ...
  const handlePhoneupdate = (e) => {
    if (e?.value) {
      Tab6UpdateFormik.setFieldValue('phone', e?.value);
      //  setSelectedGender(convertValueLabel(e?.value,e?.label))
    }
  }
                ...
                <div>
                    ...
                    <CModalBody>
                      {
                        (configurationData?.isEmpFamLoading === true) ? 'Saving Please Wait...' :
                          <CForm onSubmit={Tab6Formik.handleSubmit} className="form-horizontal">
                            <CCardBody>
                              <div className="row">
                                <div className="col-lg-3">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      <input type="text" name="name" className="form-control" placeholder='Name' maxLength={50} onChange={Tab6Formik.handleChange}
                                        onBlur={Tab6Formik.handleBlur} value={Tab6Formik.values.name} />
                                      {Tab6Formik.touched.name && Tab6Formik.errors.name ? <div className="help-block text-danger">{Tab6Formik.errors.name}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-3">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      <Select
                                        ...
                                        onBlur={Tab6Formik.handleBlur}
                                      />
                                      {Tab6Formik.touched.relationship_id && Tab6Formik.errors.relationship_id ? <div className="help-block text-danger">{Tab6Formik.errors.relationship_id}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-3">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      <Select
                                        ...
                                        onBlur={Tab6Formik.handleBlur}
                                      />
                                      {Tab6Formik.touched.gender && Tab6Formik.errors.gender ? <div className="help-block text-danger">{Tab6Formik.errors.gender}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-3">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      <input type="text" name="phone" className="form-control" placeholder='Phone' maxLength={10} onChange={Tab6Formik.handleChange} onBlur={Tab6Formik.handleBlur} value={Tab6Formik.values.phone} />
                                      {Tab6Formik.touched.gender && Tab6Formik.errors.phone ? <div className="help-block text-danger">{Tab6Formik.errors.phone}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-3">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      ...
                                      />
                                      {Tab6Formik.touched.birthday && Tab6Formik.errors.birthday ? <div className="help-block text-danger">{Tab6Formik.errors.birthday}</div> : null}
                                    </div>
                                  </div>
                                </div>
                              </div>
                  ...
                  <CModal show={openPopGroupUpdate} onClose={() => setOpenPopGroupUpdate(!openPopGroupUpdate)} size="xl" color="info">
                    ...
                    <CModalBody>
                      {
                        (configurationData?.isEmpFamLoading === true) ? 'Saving Please Wait...' :
                          <CForm onSubmit={Tab6UpdateFormik.handleSubmit} className="form-horizontal">
                            <CCardBody>
                              <div className="row">
                                <div className="col-lg-3">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      <input type="text" name="name" className="form-control" placeholder='Name' maxLength={50}
                                        onChange={Tab6UpdateFormik.handleChange} onBlur={Tab6UpdateFormik.handleBlur}
                                        value={Tab6UpdateFormik.values.name} />
                                      {Tab6UpdateFormik.touched.name && Tab6UpdateFormik.errors.name ? <div className="help-block text-danger">{Tab6UpdateFormik.errors.name}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-3">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      <Select
                                        ...
                                        onBlur={Tab6UpdateFormik.handleBlur}
                                      />
                                      {Tab6UpdateFormik.touched.relationship_id && Tab6Formik.errors.relationship_id ? <div className="help-block text-danger">{Tab6UpdateFormik.errors.relationship_id}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-3">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      <Select
                                        ...
                                        onBlur={Tab6UpdateFormik.handleBlur}
                                      />
                                      {Tab6UpdateFormik.touched.gender && Tab6UpdateFormik.errors.gender ? <div className="help-block text-danger">{Tab6UpdateFormik.errors.gender}</div> : null}
                                    </div>
                                  </div>
                                </div>
                                <div className="col-lg-3">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      <input type="text" name="phone" className="form-control" placeholder='Phone' maxLength={10}
                                        onChange={Tab6UpdateFormik.handleChange} onBlur={Tab6UpdateFormik.handleBlur}
                                        value={Tab6UpdateFormik.values.phone} />
                                      {Tab6UpdateFormik.touched.phone && Tab6UpdateFormik.errors.phone ? <div className="help-block text-danger">{Tab6UpdateFormik.errors.phone}</div> : null}
                                    </div>
                                    {/* <div className="">
                                    <input type="text"
                                      ...
                                      onChange={Tab6UpdateFormik.handleChange}
                                      onBlur={Tab6UpdateFormik.handleBlur}
                                      // value={phoneselect}
                                      value={Tab6UpdateFormik.values.phone}
                                    />
                                ...
                                <div className="col-lg-3">
                                  <div className="form-group">
                                    ...
                                    <div className="">
                                      ...
                                      />
                                      {Tab6UpdateFormik.touched.birthday && Tab6UpdateFormik.errors.birthday ? <div className="help-block text-danger">{Tab6UpdateFormik.errors.birthday}</div> : null}
                                    </div>
                                  </div>
                                </div>
                              </div>
